...
public class MyPoint
{
    ...
    public MyPoint(MyPoint other)   // copy an existing Point object
    {
        // initialise instance variables
    ...
    public MyPoint()   // initialise a default point
    {
        _x = INVALID_NUM;
        _y = INVALID_NUM;
    }
     ...
     */
    public boolean isAbove(MyPoint other) // whose y coordinates is larger
    {
     ...
     */
    public boolean isUnder(MyPoint other) // whose y coordinates is lower
    {
     ...
     */
    public boolean isLeft(MyPoint other) // whose y coordinates is larger
    {
     ...
     */
    public boolean isRight(MyPoint other)
    {
